...
```
If you use our trained model to perform cross-cell type prediction on your own DNase-seq data, please check if your normalized DNase has a similar distribution with the DNase of our training cell lines (it is preferable that the training and testing cell types use the same platform).
