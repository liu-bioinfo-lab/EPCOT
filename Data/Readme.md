...
```
If you use our trained model to perform cross-cell type prediction on your own DNase-seq data, please check if your normalized DNase has a similar distribution with the DNase of our training cell lines which are available in [Google Drive](https://drive.google.com/drive/folders/1REE056hPXSTOt2nK6B6bpkwnnofAUdsE?usp=sharing).
